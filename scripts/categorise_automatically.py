...
numbers = []
number_string = []
numbers = load_data("data_set/raw_data.txt")
numbers = normalize(numbers)
with open("data_set/raw_data_normalized.txt", 'w') as f:
...
save_sequences(numbers, mono_numbers, 1, "wdech_10.txt", widnow_size)
save_sequences(numbers, mono_numbers, -1, "wydech_10.txt", widnow_size)
